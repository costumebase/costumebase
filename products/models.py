...
class Product(models.Model):
    ...
    description = models.TextField(verbose_name='Product short description', max_length=250, blank=False)
    ...
    weekly = models.BooleanField(default=False, blank=True)
    flash_product = models.BooleanField(default=False, blank=True)
    ...
    @property
    def count_sold(self):
        return self.orderproduct_set.filter().count()
...
class CommentForm(ModelForm):
    class Meta:
        model = Comment
        fields = ['name', 'subject', 'comment', 'rate']
